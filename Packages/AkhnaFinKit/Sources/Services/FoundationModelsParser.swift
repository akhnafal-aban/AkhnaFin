...
///
/// PLAN-007: tidak lagi conform `TransactionParsing` langsung — dibungkus
/// `AppleTransactionParser` (routing per-peran). `sanitizedRupiah` dipakai dari
/// definisi tunggal di OpenRouterParser.swift.
public struct FoundationModelsParser: Sendable {
    ...
    public func parse(_ text: String, personalizationSnippet: String = "") async throws -> TransactionDraft {
