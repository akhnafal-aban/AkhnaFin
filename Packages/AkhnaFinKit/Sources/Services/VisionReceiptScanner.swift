...
private let ocrSignposter = OSSignposter(subsystem: "com.aban.AkhnaFin", category: "Parser")
private let ocrLog = Logger(subsystem: "com.aban.AkhnaFin", category: "Parser")
...
public struct VisionReceiptScanner: Sendable {
    public init() {}
